...
def plot_nearest_component_class_X_hat(args, features, labels, epoch, train_X):
    ...
    features_sort, _ = sort_dataset(features.numpy(), labels.numpy(), 
                            num_classes=10, stack=False)
    data_sort, _ = sort_dataset(train_X, labels.numpy(), 
                            num_classes=10, stack=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--inter_sample', help='plot interpolation between samples', action='store_true')
    ...
    parser.add_argument('--comp', type=int, default=12, help='number of components for PCA (default: 30)')
