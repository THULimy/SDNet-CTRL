...
def build_model(cfg):
    ...
    elif cfg.MODEL.NAME == 'sdnet18_first_layer_only':
        from Lib.models.sdnet import SDNet18_First_Layer_Only
        model = SDNet18_First_Layer_Only(num_classes=cfg.MODEL.NUM_CLASSES, cfg=cfg)
