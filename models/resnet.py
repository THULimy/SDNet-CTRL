...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, Dataname=None):
        ...
        if Dataname in ['cifar10', 'cifar100', 'cifar10-c']:
        ...
        elif Dataname in ['imagenet', 'imagenet_gaussion_noise', 'imagenet_c']:
            self.layer0 = nn.Sequential(
...
if __name__ == '__main__':
    ...
    net = ResNet50(num_classes=100, cfg=cfg)
